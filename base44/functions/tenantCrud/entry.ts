...
function mapRow(row) {
  ...
  return {
    ...
    total_paid_upfront: row.total_paid_upfront,
...
Deno.serve(async (req) => {
  try {
    ...
    if (operation === 'create') {
      const insert = { ...pickFields(data || {}), landlord_email: data?.landlord_email || user.email };
