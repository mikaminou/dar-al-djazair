...
// Agency CRM search profiles. Tied to a `clients` row (agency CRM contact),
// owned by an agency keyed by agent_email. Optional alerts route to the
// agency's email (the agent_email), mentioning the client's name.
