...
export const PROPERTY_TYPE_DEFS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "orientation",  type: "multi_enum", required: false,                           label: { en: "Orientation", fr: "Orientation", ar: "التوجيه" }, options: ORIENTATION_OPTIONS, group: "characteristics", showInSearchFilter: true, showInListingCard: false },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "water_tank",   type: "boolean", required: false,                     label: { en: "Water tank",   fr: "Réservoir / Bâche à eau", ar: "خزان ماء"    }, group: "amenities", showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 6, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Water tank" }, fr: { true: "Bâche à eau" }, ar: { true: "خزان ماء" } } },
      { key: "garden",     type: "boolean", required: false,                       label: { en: "Garden",           fr: "Jardin",                ar: "حديقة"                }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
      ...
      { key: "has_well",   type: "boolean", required: false,                       label: { en: "Well",             fr: "Puits",                 ar: "بئر"                  }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
      ...
      { key: "boundary_walls", type: "boolean", required: false,                   label: { en: "Walled / Fenced",  fr: "Clôturé",               ar: "مسوّر"                }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 5, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Walled" }, fr: { true: "Clôturé" }, ar: { true: "مسوّر" } } },
      { key: "has_summer_kitchen", type: "boolean", required: false,               label: { en: "Summer Kitchen",   fr: "Cuisine d'été",         ar: "مطبخ صيفي"           }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
      ...
      { key: "terrace",      type: "boolean", required: false,                       label: { en: "Terrace",          fr: "Terrasse",              ar: "تراس"                 }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 9, cardBadgeStyle: "positive", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Terrace" }, fr: { true: "Terrasse" }, ar: { true: "تراس" } } },
      { key: "fiber_internet",type: "boolean", required: false,                       label: { en: "Fiber Internet",   fr: "Fibre optique",       ar: "ألياف بصرية"         }, group: "amenities",        showInSearchFilter: false, showInListingCard: false },
       ...UNIVERSAL_AMENITIES.map(opt => ({ 
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "bathrooms",    type: "number",  required: true,                        label: { en: "Bathrooms",        fr: "Salles de bain",        ar: "الحمامات"             },             min: 0, max: 10,                     group: "characteristics", showInSearchFilter: true,  showInListingCard: true,  cardOrder: 5, cardIcon: "bath", cardFormat: "icon_value" },
      { key: "levels",       type: "number",  required: true,                        label: { en: "Levels / Floors",  fr: "Niveaux",               ar: "الطوابق"              },             min: 1, max: 10,                     group: "characteristics", showInSearchFilter: false, showInListingCard: false },
      { key: "has_servant_quarters", type: "boolean", required: false,              label: { en: "Servant Quarters", fr: "Chambre de bonne",      ar: "غرفة الخدم"           }, group: "characteristics", showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 12, cardBadgeStyle: "positive", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Servant Quarters" }, fr: { true: "Chambre de bonne" }, ar: { true: "غرفة الخدم" } } },
      { key: "is_gated_community", type: "boolean", required: false,                label: { en: "Gated Community",  fr: "Résidence sécurisée",   ar: "مجمع آمن"             }, group: "characteristics", showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 11, cardBadgeStyle: "positive", cardBadgeCondition: "if_true",
      ...
      { key: "has_basement",  type: "boolean", required: false,                    label: { en: "Basement",        fr: "Sous-sol",           ar: "قبو"                 }, group: "characteristics", showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 8, cardBadgeStyle: "positive", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Basement" }, fr: { true: "Sous-sol" }, ar: { true: "قبو" } } },
      { key: "heating_type",  type: "enum",    required: false,                    label: { en: "Heating type", fr: "Type de chauffage", ar: "نوع التدفئة" }, options: HEATING_TYPE_OPTIONS, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "water_tank",   type: "boolean", required: false,                     label: { en: "Water tank",   fr: "Réservoir / Bâche à eau", ar: "خزان ماء"    }, group: "amenities", showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 6, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Water tank" }, fr: { true: "Bâche à eau" }, ar: { true: "خزان ماء" } } },
      ...
      { key: "has_summer_kitchen", type: "boolean", required: false,               label: { en: "Summer Kitchen",   fr: "Cuisine d'été",         ar: "مطبخ صيفي"           }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 6, cardBadgeStyle: "positive", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Summer Kitchen" }, fr: { true: "Cuisine d'été" }, ar: { true: "مطبخ صيفي" } } },
      { key: "has_summer_living_room", type: "boolean", required: false,           label: { en: "Summer Living Room", fr: "Salon d'été",           ar: "صالة صيفية"           }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
      ...
      { key: "has_well",   type: "boolean", required: false,                       label: { en: "Well",             fr: "Puits",                 ar: "بئر"                  }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "boundary_walls", type: "boolean", required: false,                   label: { en: "Walled / Fenced",  fr: "Clôturé",               ar: "مسوّر"                }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "has_alarm",    type: "boolean", required: false,                     label: { en: "Alarm System",     fr: "Alarme",                ar: "نظام إنذار"          }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 7, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "has_storage",     type: "boolean",    required: false, label: { en: "Has Storage",    fr: "Espace stockage", ar: "مستودع"        }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "parking",         type: "boolean",    required: false, label: { en: "Parking",        fr: "Parking",         ar: "موقف سيارات"  }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 5, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Parking" }, fr: { true: "Parking" }, ar: { true: "موقف" } } },
      { key: "has_water_meter",  type: "boolean",    required: false, label: { en: "Water Meter",     fr: "Compteur d'eau",  ar: "عداد ماء"      }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "has_electricity_meter", type: "boolean", required: false, label: { en: "Electricity Meter", fr: "Compteur d'électricité", ar: "عداد كهرباء" }, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "has_gas",         type: "boolean",    required: false, label: { en: "Natural Gas",    fr: "Gaz de ville",    ar: "غاز طبيعي"     }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "security",        type: "boolean",    required: false, label: { en: "Security",       fr: "Sécurité",        ar: "أمان"          }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "air_conditioning", type: "boolean",    required: false, label: { en: "Air Conditioning", fr: "Climatisation",   ar: "تكييف هواء"  }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "has_elevator",     type: "boolean", required: false, label: { en: "Elevator",         fr: "Ascenseur",           ar: "مصعد"                    }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 8, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Elevator" }, fr: { true: "Ascenseur" }, ar: { true: "مصعد" } } },
      { key: "has_collective_heating", type: "boolean", required: false, label: { en: "Collective Heating", fr: "Chauffage collectif", ar: "تدفئة جماعية" }, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "security",         type: "boolean", required: false, label: { en: "Security",         fr: "Sécurité",            ar: "أمان"                    }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "generator",        type: "boolean", required: false, label: { en: "Generator",        fr: "Générateur",          ar: "مولد كهرباء"            }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "water_tank",       type: "boolean", required: false, label: { en: "Water Tank",       fr: "Citerne d'eau",       ar: "خزان ماء"               }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "year_built",       type: "number",  required: false, label: { en: "Year Built",       fr: "Année de constr.",    ar: "سنة البناء"              }, min: 1900, max: 2030, group: "construction", showInSearchFilter: false, showInListingCard: false },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "has_elevator",  type: "boolean",    required: false,                       label: { en: "Elevator",      fr: "Ascenseur",     ar: "مصعد"          }, group: "amenities",        showInSearchFilter: true, showInListingCard: false,
        showAsCardBadge: true, cardBadgePriority: 5, cardBadgeStyle: "neutral", cardBadgeCondition: "if_true",
        cardBadgeLabel: { en: { true: "Elevator" }, fr: { true: "Ascenseur" }, ar: { true: "مصعد" } } },
      { key: "is_accessible",  type: "boolean",    required: false,                       label: { en: "Wheelchair Accessible", fr: "Accessible aux PMR", ar: "متاح للأشخاص ذوي الإعاقة" }, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "has_kitchen",    type: "boolean",    required: false,                       label: { en: "Kitchen / Pantry", fr: "Cuisine / Coin café", ar: "مطبخ / ركن القهوة" }, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "has_archive_room", type: "boolean",  required: false,                       label: { en: "Archive Room", fr: "Salle d'archives", ar: "غرفة الأرشيف" }, group: "amenities", showInSearchFilter: true, showInListingCard: false },
      { key: "air_conditioning", type: "boolean",    required: false,                       label: { en: "Air Conditioning", fr: "Climatisation",   ar: "تكييف هواء"  }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "fiber_internet",  type: "boolean",    required: false,                       label: { en: "Fiber Internet",   fr: "Fibre optique",   ar: "ألياف بصرية" }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "security",        type: "boolean",    required: false,                       label: { en: "Security",        fr: "Sécurité",        ar: "أمان"          }, group: "amenities",        showInSearchFilter: true, showInListingCard: false },
      { key: "suitable_for",  type: "multi_enum", required: false,                       label: { en: "Suitable For",  fr: "Adapté pour",   ar: "مناسب لـ"      }, options: [
