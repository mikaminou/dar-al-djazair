              ...
              {conversations.map(conv => {
                ...
                return (
                  <div
                    ...
                    className={`relative group w-full text-left px-4 py-3 flex items-start gap-3 border-b border-gray-50 hover:bg-emerald-50 transition-colors cursor-pointer ${isActive ? "bg-emerald-50 border-l-2 border-l-emerald-500" : ""}`}
                  >
